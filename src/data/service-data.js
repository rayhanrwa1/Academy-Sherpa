...
const  service_data = [
    // for home 01 
    {
        ...
        icon: img_1,
        img: img_1,
        title: "1on1 Interview Mentoring",
        description: <>Fitur ini menyediakan sesi mentoring secara personal antara <br />  mentor dan mentee untuk mempersiapkan mereka dalam menghadapi wawancara beasiswa dengan lebih percaya diri dan efektif.</>,
        delay: ".4s",
    },
    {
        id: 2,
        icon: img_2,
        img: img_2,
        title: "Mentee's Tracker",
        description: <>Fitur ini memungkinkan mentee untuk melacak kemajuan mereka dalam perjalanan mencapai beasiswa, termasuk pencapaian-pencapaian tertentu, tugas-tugas yang telah diselesaikan, dan tujuan-tujuan yang telah dicapai.</>,
        delay: ".6s",
    },
    {
        id: 3,
        icon: img_3,
        img: img_3,
        title: "Sherpa Scholarship Workbook ",
        description: <>Buku kerja ini dirancang untuk membantu mentee dalam merencanakan dan melacak langkah-langkah yang diperlukan untuk mencapai beasiswa</>,
        delay: ".7s",
    },
    {
        id: 4,
        icon: img_4,
        img: img_4,
        title: "Bank Data Sherpari:",
        description: <>Bank Data Sherpari adalah sebuah kumpulan informasi yang mencakup data tentang berbagai beasiswa yang tersedia selama beberapa tahun terakhir. Ini mencakup detail seperti daftar beasiswa, kriteria kelayakan, jumlah penerimaan, tahapan aplikasi, lembaga penyedia, serta statistik tentang keberhasilan aplikasi dan distribusi beasiswa.</>,
        delay: ".8s",
    },
    {
        id: 5,
        icon: img_5,
        img: img_5,
        title: "Sherpa's Mentoring Report",
        description: <> Fitur ini mencakup laporan yang menyajikan evaluasi kemajuan mentee selama sesi mentoring, termasuk kekuatan, kelemahan, dan area-area yang perlu diperbaiki. </>,
        delay: ".9s",
    },
