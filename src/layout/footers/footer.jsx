...
const footer_content  = {
    title: <>Dapatkan Update <br /> Informasi Terbaru</>,
    description: <>Sherpa Academy hadir untuk membantu ribuan mahasiswa <br /> </>,
    phone: "+62 856-4834-6907",
    contact_mail: "academysherpa@gmail.com",
                                 ...
                                 <div className="tp-footer__contact-info tp-footer__icon-space">
                                    <ul>
                                       <li>
                                          ...
                                          <Link href={`tel:085648346907`}>{phone}</Link>
                                       </li>
                                       <li>
                                          <span>
                                            <ContactIcon /> 
                                          </span>
                                          <Link href={`mailto:academysherpa@gmail.com`}>{contact_mail}</Link>
                                       </li>
                                       <li>
                                          <span>
                                            <LocationIcon /> 
                                          </span>
                                          <Link href="https://maps.app.goo.gl/auo9H7n8RvENuEGQ6"
                                 ...
                                 <ul>
                                    <li>
                                       <button id="tp-copyright__lang-toggle" onClick={() => oppenLan()} >
                                          <span>Indonesia (IDN)<i className="fal fa-angle-down"></i></span>
                                       </button>
