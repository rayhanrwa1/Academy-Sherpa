...
const inner_content = {
  title: "Kontak Kami",
  description: <>Kami akan membalas kurang dari 24 Jam</>,

  contact_data: [
    {
      id: 1,
      icon: icon_1,
      title: "academysherpa@gmail.com",
      link: "mailto:academysherpa@gmail.com",
    },
    {
      id: 2,
      icon: icon_2,
      title: "085648346907",
      link: "tel:085648346907",
    },
    {
      id: 3,
      icon: icon_3,
      title: "Malang, Jawa Timur",
      link: "hhttps://maps.app.goo.gl/k9AMujbq9bxjvndKA",
    },
  ],
};
