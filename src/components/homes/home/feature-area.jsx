...
// icon import 
import icon_1 from "../../../../public/assets/img/feature/fea-icon-1.svg";
import icon_2 from "../../../../public/assets/img/feature/fea-icon-2.svg";
import icon_3 from "../../../../public/assets/img/feature/fea-icon-3.svg";
...
const feature_data = [
   {
      id: 1,
      img: icon_1,
      title: <>Mentoring yang Dipersonalisasi</>,
      delay: ".4s",
   },
   {
      id: 2,
      img: icon_2,
      title: <>Fokus pada Pengembangan Diri</>,
      delay: ".6s",
   },
   {
      id: 3,
      img: icon_3,
      title: <>Platform <br /> Inovatif</>,
      delay: ".8s",
   },
]
...
const feature_content = {
   title: "Keunggulan Sherpa Academy",
   sub_title: "",
}
