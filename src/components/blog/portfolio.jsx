                  ...
                  <div className="row justify-content-center">
                     <div className="col-lg-8">
                        <div className="tp-about__section-box text-center mb-40">
                           <h4 className="inner-section-subtitle">Acara dan Komunitas</h4>
                           <h3 className="tp-section-title">Event Sherpa Academy</h3>
                           <p>Dapatkan perkembangan acara terbaru Sherpa Academy</p>
                        </div>
                     </div>
                  </div>
                  {/* <div className="row">
