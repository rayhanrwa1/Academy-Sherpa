...
import portfolio_blog from '@/src/data/program-blog';
                  ...
                  <div className="row justify-content-center">
                     <div className="col-lg-8">
                        <div className="tp-about__section-box text-center mb-40">
                           <h4 className="inner-section-subtitle">Program dan Kelas Mentoring</h4>
                           <h3 className="tp-section-title">Program Kelas Mentoring</h3>
                           <p>Program Mentoring Sherpa membawa pengalaman mendalam bagi para peserta. Kami tidak hanya menawarkan kelas-kelas, tetapi juga membangun komunitas yang saling mendukung dan mendorong pertumbuhan bersama. Sertai kami dalam perjalanan ini dan temukan potensi penuh Anda!</p>
                        </div>
                     </div>
                  </div>
                  {/* <div className="row">
    ...
    <div key={i} data-index={i} className="col-xl-4 col-lg-6 col-md-6 mb-30 grid-item cat1 cat4 cat3 cat5">
        <div className="tp-blog-item">
            <div className="tp-blog-thumb fix">
                <Link href={item.link}><Image src={item.thumb_img} alt="theme-pure" /></Link>
            </div>
            <div className="tp-blog-content">
                ...
                <div className="tp-blog-title-box">
                    <Link href={item.link} className="tp-blog-title-sm">{item.title}</Link>
                </div>
